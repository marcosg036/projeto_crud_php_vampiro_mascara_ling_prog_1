    ...
    <main>
        <div class="form">
            <form action="action/delete_action.php" method="get">
                ...
                <label for="nao_delete">Apagar?<input type="radio" name="confirmar" value="nao" id="nao_delete"></label>
                <br>
                <label for="sim_delete">Apagar.<input type="radio" name="confirmar" value="sim" id="sim_delete"></label>
                <br>
